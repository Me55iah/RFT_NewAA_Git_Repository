...
import resources.Motor_MK2.Done.InstalmentsHelper;
 ...
 * @author horned
 */
public class Instalments extends InstalmentsHelper
{
	/**
	 * Script Name   : <b>Instalments</b>
...
//		//-----------------------------------------------------------------------------------------
//		String sExpectedQuoteReference = "ZU17181221Z8"; // WW3MT19681SM";
...
//		String sExpectedCoverStart = "Mon 10 August 2015";
//		String sExpectedRenewalDate = "Wed 10 August 2016";
//		String sExpectedPolicyPrice = "£2,127.40";
//		String sExpectedCCCharge = "1.5"; // % Charged
//		String sExpectedTotalCost = "£2,383.09";
//		
//		String sPaymentType = "Instalment"; // Single Payment
//		
//		String sDeposit = "210.04";
//		String sPostalCharge = "1.99";
//		String sPolicyBalance = "2,167.88";
//		//String sExpectedDeposit = 
		//-----------------------------------------------------------------------------------------
		// Test Data   -  COMMENT OUT FOR OPERATIONALE USAGE
		//-----------------------------------------------------------------------------------------
		String sExpectedQuoteReference = Common_Variables.intermediateQuoteReference;  // intermediateQuoteReference
		String sQuoteRemainingBalance = Common_Variables.PolicyRemainingBalance; 
		...
		String sExpectedPolicyPrice = Common_Variables.initialAnnualCost; //Common_Variables.initialAnnualCost; // 1aCommon_Variables.carInsuranceAnnual; //Common_Variables.policyPrice;
		...
		String sPolicyDocumentTransmission = Common_Variables.policyDocuments;
//--------------------------------------------------------------------------------		
		// BrowserSync();
		//--------------------------------------------------------------------------------	
...
//		//--------------------------------------------------------------------------------		
		...
		//--------------------------------------------------------------------------------		
		//                      |------- Actual -------|------- Expected -------|      
		VerifyandReport(svTitle, sActualQuoteReference, sActualQuoteReference, sReport);                                  // 1 off ok, multis fail
		...
		try {                        // Single Payment
			...
			subString(sStringData, sStartName, sEndName, iIndex, sStartNameContent);
			sActualPolicyPrice = Common_Variables.sActual;
			sExpectedPolicyPrice = Common_Variables.PolicyRemainingBalance;
			//--------------------------------------------------------------------------------	
		}
		//--------------------------------------------------------------------------------		
...
//		dExpectedCCCharge = Double.parseDouble(sExpectedCCCharge);
		// Expected Rounding
		//dExpectedCCCharge = dExpectedCCCharge * 100.00 /100.00;
		//sExpectedCCCharge = new Double(dExpectedCCCharge).toString();
		
		// Actual Rounding
		//dActualCCCharge = dActualCCCharge * 100.00 /100.00;
		//sActualCCCharge = new Double(dActualCCCharge).toString();   // CC Charge Factored In Elsewhere, Across The Totalling
