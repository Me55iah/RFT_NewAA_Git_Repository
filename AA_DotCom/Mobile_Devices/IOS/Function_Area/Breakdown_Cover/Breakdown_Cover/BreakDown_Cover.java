package Mobile_Devices.IOS.Function_Area.Breakdown_Cover.Breakdown_Cover;
import resources.Common_Variables;
import resources.Mobile_Devices.IOS.Function_Area.Breakdown_Cover.Breakdown_Cover.BreakDown_CoverHelper;
...
//		}
		...
		//--------------------------------------------------------------------
		// Submit - Should be gone, But unattended executions, return takes longer on first iteration
		try {
			button_continuesubmit().waitForExistence(1,  0.25);
			button_continuesubmit(ANY, READY).click();
			System.out.println("Final Attempt At Submit on Breakdown Screen");
		} catch (ObjectNotFoundException e) {
			System.out.println("Arrived at Personal Details Screen OK");
		}
		//--------------------------------------------------------------------		
