...
import resources.Mobile_Devices.IOS.I_Device_TestHelper;
 ...
 * @author horned
 */
public class I_Device_Test extends I_Device_TestHelper
{
	/**
	...
	public static String[] environmentURL = new String[1];
		...
		public void testMain(Object[] args) {
			...
			//--------------------------------
			// Start Environment and Emulator
			...
			System.out.println("Started ROAD - UK Breakdown Cover (NEW) Tests for IPAD .....");
...
//			this.dpInitialization(dp, Common_Variables.startRow);
			...
			while (!dpDone()) {
				...
				Common_Variables.Mobile_Device = dpString("Mobile_Device");
				Common_Variables.Mobile_Device_Orientation = dpString("Mobile_Device_Orientation");
				...
				// Select Device Type
				callScript("Mobile_Devices.IOS.Device_Selector");
				//--------------------------------
				
				//--------------------------------
				// Navigate to Function Within Website -Breakdown UK
				//--------------------------------
				callScript("Mobile_Devices.IOS.Function_Area.Function_Area");
				//--------------------------------
				...
				System.gc();
				// Create over      			- Stage 1
				callScript("Mobile_Devices.IOS.Function_Area.Breakdown_Cover.Breakdown_Cover.BreakDown_Cover");
				//------------------------------------------------
				unregisterAll();
				System.gc();
