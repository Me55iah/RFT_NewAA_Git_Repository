...
import resources.Aggregators.Home.Verify_Home_Contents_QuoteHelper;
 ...
 * @author horned
 */
public class Verify_Home_Contents_Quote extends Verify_Home_Contents_QuoteHelper
{
	/**
	 * Script Name   : <b>Verify_Home_Contents_Quote</b>
	 * Generated     : <b>7 May 2015 13:28:20</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		logInfo(" START OF Common Value Tests For Contents ONLY Quote");
		Common_Variables.xmlInsuranceType = "2"; // Contents
		...
		callScript("Aggregators.Home.Verify_Home_Common_Content");
		//------------------------------------------------------
		logInfo(" END OF Common Value Tests For Contents ONLY Quote");
