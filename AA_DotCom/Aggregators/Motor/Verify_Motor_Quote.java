...
import resources.Aggregators.Motor.Verify_Motor_QuoteHelper;
 ...
 * @author horned
 */
public class Verify_Motor_Quote extends Verify_Motor_QuoteHelper
{
	/**
...
//		String sDOB = Common_Variables.proposerDOB;
		...
		switch (Common_Variables.xmlInsurerName){
			...
			case "Premie": // 
				Common_Variables.xmlInsurerName = "Premier (AA)";
				break;
...
//		VerifyandReport("Start_Date_Match", sDateStamp.trim(), sStartDate.trim(), " Policy Start Date ");
		System.out.println(sDateStamp+" sDateStamp "+sStartDate+" Start Date ");// 
		//--------------------------------------------------------------------------
...
//		VerifyandReport("End_Date_Match", sEndDate.trim(), sDateStamp.trim(), " Policy End Date ");				
		System.out.println(sDateStamp+" sDateStamp "+sEndDate+" End Date ");// 
		//--------------------------------------------------------------------------		
//		//\\\\\\\\\\\\\\\\
...
//			round2SigFigs(Common_Variables.xmlCalculatedCredit, sxmlCalculatedCredit);
			...
			String sTotPay = sTPay[5]; String sTotalPayable = sTotPay.substring(0, i); // +1 1405
			//-----------------
