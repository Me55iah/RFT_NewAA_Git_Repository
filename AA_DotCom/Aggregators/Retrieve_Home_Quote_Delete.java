...
import resources.Aggregators.Retrieve_Home_Quote_DeleteHelper;
 ...
 * @author horned
 */
public class Retrieve_Home_Quote_Delete extends Retrieve_Home_Quote_DeleteHelper
{
	/**
...
//			}
			...
			unregisterAll();
			callScript("Aggregators.Verify_Home_Quote");
