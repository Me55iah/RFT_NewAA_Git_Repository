...
import resources.Road.OffersHelper;
...
public class Offers extends OffersHelper
{
	/**
	...
	public void testMain(Object[] args) 
	{
		...
		//------------------------------------------------------------------
		// Environment Start
		environmentURL[0] = "http://prelive1.theaa.com/breakdown-cover"; 	// was init  3	
		...
		// <£95
		//------------------------------------------------------------------
		// Select Cover for You and 1 Year <£95
		//------------------------------------------------------------------
